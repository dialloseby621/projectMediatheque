<?php
		...
		if($_SERVER["REQUEST_METHOD"] == "POST")
		{
			...
			{
			    $db = Database::connect();
	            $statement = $db->prepare("INSERT INTO emprunt(ida,idd) values(?, ?)");
...
<html>
	...
	<h2 class="ajout"> Ajout Emprunt </h2>
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1">
				<form id="contact-form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" role="form">
					...
					<p class="thank-you" style="display:<?php if($isSucces) echo "block";else echo "none"; ?>">Merci pour l'Ajout d'un nouveau Emprunt </p>
